...
function Editor(_ref) {
  ...
  var changeActiveOption = function changeActiveOption(currentState) {
    ...
    if (currentStyle.has(inlineOptions.bold)) tempActiveOptions.bold = true;else tempActiveOptions.bold = false;
    if (currentStyle.has(inlineOptions.italic)) tempActiveOptions.italic = true;else tempActiveOptions.italic = false;
    if (currentStyle.has(inlineOptions.underline)) tempActiveOptions.underline = true;else tempActiveOptions.underline = false;
    if (currentStyle.has(inlineOptions.strikethrough)) tempActiveOptions.strikethrough = true;else tempActiveOptions.strikethrough = false;
    if (currentStyle.has(inlineOptions.highlight)) tempActiveOptions.highlight = true;else tempActiveOptions.highlight = false;
    if (currentStyle.has(inlineOptions.code)) tempActiveOptions.code = true;else tempActiveOptions.code = false;
    if (blockType === blockOptions.ul) tempActiveOptions.ul = true;else tempActiveOptions.ul = false;
    if (blockType === blockOptions.ol) tempActiveOptions.ol = true;else tempActiveOptions.ol = false;
    if (blockType === blockOptions.h1) tempActiveOptions.h1 = true;else tempActiveOptions.h1 = false;
  ...
  var styleMap = (_styleMap = {}, _defineProperty(_styleMap, inlineOptions.highlight, {
    ...
    color: (colors === null || colors === void 0 ? void 0 : colors.code) || "#e01e5a"
  }), _styleMap);
  return /*#__PURE__*/_react.default.createElement("div", {
    ref: containerRef,
    className: "".concat(readOnly ? _EditorModule.default.readOnly : "", " ").concat(_EditorModule.default.container, " ").concat(error ? errorClassName ? errorClassName : _EditorModule.default.error : "", " ").concat(className ? className : "")
  }, !readOnly && !toolbarToBottom ? /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, toolbar, !hideSeparator && /*#__PURE__*/_react.default.createElement("div", {
  ...
  }))), toolbarToBottom && !readOnly ? /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, !hideSeparator && /*#__PURE__*/_react.default.createElement("div", {
    className: _EditorModule.default.separator
  }), toolbar) : "");
}
